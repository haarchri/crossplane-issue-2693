...
kind create cluster --name=2693-1.4.0
kubectx kind-2693-1.4.0
kubectl create ns crossplane-system
helm install crossplane --namespace crossplane-system crossplane-stable/crossplane --version 1.4.0 --wait
...
# kind delete cluster --name 2693-1.4.0